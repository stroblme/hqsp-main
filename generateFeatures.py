...
def poolProcess_wave(portDatsetLabelFiles):
    ...
    wave = gen_wave(portDatsetLabelFiles)
    return wave
...
def gen_wave_features(labels:list, train_audio_path:str, outputPath:str, PoolSize:int, waveformPath:str=None, portion:int=1, split:bool=True):
    all_wave = list()
    all_labels = list()
